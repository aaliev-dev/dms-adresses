...
<div id="app">
  <div id="sidebar">
    ...
    <div id="filters">
      <button data-filter="all" class="active"><span class="filter-dot" style="background:#333"></span>Все</button>
...
function markerColor(c) {{
  ...
  if (s.includes('стоматолог')) cats++;
  if (s.includes('на дому')) cats++;
  if (s.includes('экстренн')) cats++;
  if (cats >= 2) return 'islands#blackMedicalIcon'; // совмещённые (несколько услуг)
